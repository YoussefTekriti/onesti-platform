...
const testimonials = [
  {
    id: 1,
    content:
      "I am immensely grateful for the positive impact ONESTI has had on my son's speech and language development in both Arabic and English.",
  ...
  },
  {
    id: 2,
    content:
      'I am incredibly happy and grateful for ONESTI. The counselor has been a "game-changer" for my son\'s behavior during the past few months.',
