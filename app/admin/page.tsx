...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="flex-1">
      <AdminHeader title="Dashboard" description="Welcome to the Onesti admin dashboard" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          rows={3}
                          className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md"
                          defaultValue="Onesti is a comprehensive platform for pediatric therapy and assessment services."
                        ></textarea>
                      </div>
                    </div>
                  </div>
