...
const testimonials = [
  {
    body: "Onesti helped us identify our son's speech delay early. The milestone tracker was so easy to use, and the specialists were incredibly supportive.",
    author: {
      name: "Sarah Johnson",
  ...
  {
    body: "As a speech therapist, I love how Onesti streamlines the assessment process. The platform makes it easy to track progress and share reports with parents.",
    author: {
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">See how Onesti has helped families and specialists</p>
        </div>
