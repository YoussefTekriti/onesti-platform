...
const faqs = [
  {
    question: "What services does Onesti provide for children?",
    answer:
      "Onesti provides comprehensive pediatric care services including developmental assessments, speech therapy, occupational therapy, behavioral therapy, and parent coaching. We offer both in-person and telepractice options to support your child's unique needs.",
  },
  {
